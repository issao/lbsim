...
**Last updated:** 2026-09-06 21:01 PDT. **STOPPING at Issao's request** (usage limit approaching; verbatim via main: *"ask tl to find a reasonable stopping point and pause work, documenting state. tie up lose ends, make sure that all links and pages stage clearly what is mock, what is data reply and what is live."*): every in-flight unit was told at 21:01 to finish within ten minutes or push a WIP checkpoint and stop; one last unit U70 labels every page and link mock / replay / live; the STOPPED checkpoint with Resume paragraphs follows in the next update. **RESUMED 20:26 PDT** after the 17:35–20:21 pause; a fresh tech lead (aa236236554a3edd1) restarted from this file. **Done 51 · in flight 9 (finishing or checkpointing) · queued 9 · paused 1 (S3) · waiting on Issao 1.**
...
**Dynamics, of 11 selected: 11 showcased on recordings (U60, 2ce802c) · 10 live-runnable on the dashboard page (demo 11's preemption keys are not yet in the control panel's config mapping) · 10 showcased-live since U58 (a94693b), and since U59b (7cc3395) a walkthrough's `set` steps apply to the live run, forward-only.** Three counts rather than one, per main at 20:49, so the number Issao reads does not claim what it does not yet mean. Selected: findings 1–6, demos 7–10, demo 11 (U22). Live means the dynamic runs through the Ingress endpoint in the dashboard (U18, U28); showcased means a walkthrough script steps through it (U48, U49); showcased-live means the Showcase page itself opens a live run of the script's scenario (U58). The goal, from Issao at 16:53: *"all selected dynamics are live demoable in the dashboard and in the showcase page."*
...
flowchart TD
  ...
  U04 --> U40a & U40b
  U40a & U40b --> U40
  U25[U25a SLO classes in the engine<br/>claude/tl-slo-classes]:::flight
  U25b[U25b per-class rows in report and export]:::queued
  U25 --> U25b
  U26[U26 speculative decoding knob]:::done
  U26b[U26b demo 12 spec decoding + walkthrough<br/>claude/tl-spec-demo, sonnet]:::flight
  U26 --> U26b
  U70[U70 mock / replay / live labels on every page<br/>claude/tl-data-labels, sonnet]:::flight
  U52 --> U70
  ...
  U31[U31a failure injection in the engine<br/>claude/tl-failures]:::flight
  ...
  U28 --> U61
  U22 --> U62
  U63[U63 trace workload: sort rows, offered_rps in trace mode<br/>claude/tl-trace-fixes, sonnet]:::flight
  U64[U64 runner: skip on live, cursor past step, early end<br/>claude/tl-runner-fixes, sonnet]:::flight
  U65[U65 trace recorder: bounded snapshots<br/>claude/tl-trace-growth, sonnet]:::flight
  U66[U66 golden file merges by union; html_md5 without the scenario block<br/>claude/tl-golden-union, sonnet]:::flight
  U68[U68 integrate.sh: md-only diffs skip the gate<br/>claude/tl-integrate-md, sonnet]:::flight
