...
pub const METRICS: &[(&str, i32)] = &[
    ...
    ("METRIC_QUEUED_DECODE_SEQS", 72),
    ("METRIC_QUEUED_PREFILL_SEQS", 73),
    ("METRIC_DECODE_BEYOND_BUFFER", 74),
    ("METRIC_PREFILL_BEYOND_BUFFER", 75),
];
...
pub const METRIC_TIER_UTILIZATION: i32 = 27;
pub const METRIC_TIER_BANDWIDTH_UTILIZATION: i32 = 28;
...
pub const METRIC_PREEMPTIONS_PER_S: i32 = 46;
pub const METRIC_RETRIES_PER_S: i32 = 47;
pub const METRIC_PREFIX_HIT_RATE: i32 = 48;
pub const METRIC_READY_REPLICAS: i32 = 60;
pub const METRIC_WARMING_REPLICAS: i32 = 61;
pub const METRIC_DRAINING_REPLICAS: i32 = 62;
...
mod tests {
    ...
    fn metric_constants_are_in_the_table() {
        for (name, num) in [
            ...
            ("METRIC_TIER_UTILIZATION", METRIC_TIER_UTILIZATION),
            ("METRIC_TIER_BANDWIDTH_UTILIZATION", METRIC_TIER_BANDWIDTH_UTILIZATION),
            ...
            ("METRIC_WARMING_REPLICAS", METRIC_WARMING_REPLICAS),
            ("METRIC_DRAINING_REPLICAS", METRIC_DRAINING_REPLICAS),
