    ...
    <div className="home">
      ...
      <ul className="surfaces">
        <li>
          ...
          <p>Four routing policies at identical load and seed. <code>reports/1-routing.html</code></p>
        </li>
        <li>
          <a href="reports/2-staleness.html">2. Herding is a smooth function of staleness, and it is steep</a>
          <p>Telemetry interval swept from 100 ms to 4 s. <code>reports/2-staleness.html</code></p>
        </li>
        <li>
          <a href="reports/3-chunking.html">3. Prefill and decode contend for one device, and no setting wins both</a>
          <p>Chunked-prefill budget swept from 512 to 16,384 tokens. <code>reports/3-chunking.html</code></p>
        </li>
        <li>
          <a href="reports/4-load-curve.html">4. Past the knee, offering more load delivers less work</a>
          <p>Offered load swept from 30 to 230 requests per second. <code>reports/4-load-curve.html</code></p>
        </li>
        <li>
          ...
          <p>Long-context share swept from 0 to 32%. <code>reports/5-long-context.html</code></p>
        </li>
        <li>
          <a href="reports/6-retry.html">6. A retry budget is the difference between a bad minute and an outage</a>
          <p>No retries, a retry budget, and a retry storm, after the same load spike. <code>reports/6-retry.html</code></p>
        </li>
      </ul>
