...
// U95/U95b: a partial panel on a live or replay run borrows the run's own word, full stop -- its
// unwired fields render as "—" rather than as placeholders, so the tag has nothing to qualify.
// Only mock mode, a genuinely mock frame, and absent realness still say the bare word `mock`.
