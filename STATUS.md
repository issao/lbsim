...
| Execution graph: 22 done, 10 in flight, 17 queued, 1 waiting on Issao; status line counts dynamics live and showcased, **0 of 10 selected** | `docs/execution-graph.md` (e48887a) | read it |
