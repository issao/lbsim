...
| Execution graph: 33 done, 10 in flight, 14 queued, S3 paused, 1 waiting on Issao; resumed 20:26 with twelve units spawned in one wave, five of them in place in the worktrees whose agents the rate limit killed, none lost; U56 `Sim::drain_frames` from the main agent's 20:28 decision on R1 item 8, U57 spawning; status line counts dynamics live and showcased, **0 of 11 selected** (U22 added demo 11), moves when U49 lands (U48 landed 20:38, after this checkpoint) | `docs/execution-graph.md` (cf30e7f, merged 9c33433, 20:35) | read it |
