...
**Last updated:** 2026-09-06 20:53 PDT by Claude.
...
| Execution graph: 40 done, 13 in flight including reviews R2 and R3 (U40a and U40b at their final rebases), 10 queued, S3 paused, 1 waiting on Issao; **dynamics live and showcased 10 of 11 selected** by the graph's own definition (U18, U28, U48, U49 on master; every one of the ten scripts opens its exported recording in the Showcase page and the same scenarios run live on the dashboard page; the Showcase page opening a live run itself was U58, landed 20:50; `set` steps applying live wait on U59a then U59b; demo 11's script got its run ids in U60, landed 20:51, so the eleventh is the tech lead's to count); seven units and R3 spawned at 20:50 (U58, U60, U59a `Sim::apply_overrides`, U25a SLO classes, U26 speculative decoding, U31a failure injection, R3 over six merges); the 20:46/20:47 stamps restamped to the commit time 20:42 | `docs/execution-graph.md` (71dde26, merged 13d884a, 20:51) | read it |
